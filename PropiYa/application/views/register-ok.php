        ...
        <div class="container">
            ...
            <div class="row">
                <div style="text-align: center;" class="col-md-12">
                    ...
                    <h1><b>Gracias por registrarte</b></h1>
                    <br/><br/>
                    <i style="font-size: 96px;" class="im im-icon-Checked-User"></i>
                    <h3>El registro ha sido exitoso, por favor, revis&aacute; tu email para activar tu cuenta, de esta manera nos aseguramos que todos nuestros usuarios sean reales. <br/><br/>En caso que no te llegue el e-email, por favor revis&aacute; tu carpeta de <strong>SPAM</strong>.<br/><br/>¡Gracias! El equipo de propiya.com</h3>
                    <br/><br/>
                </div>
            </div>
